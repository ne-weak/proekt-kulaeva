...
const results = {
    sanguine: {
        ...
        desc: "<b>Психологический портрет:</b> Вы представляете собой тип личности с сильной и подвижной нервной системой. В процессе социализации вы легко усваиваете нормы общества. <br><br><b>В общении:</b> Вы — 'социальный клей'. Ваша способность к эмпатии и природный оптимизм делают вас желанным собеседником. Ваше влияние на окружающих всегда созидательно."
    },
    choleric: {
        title: "Мощный Холерик",
        desc: "<b>Психологический портрет:</b> Ваша личность базируется на страстном, неуравновешенном типе темперамента. Вы — индивид, ориентированный на преобразование реальности. <br><br><b>В общении:</b> Вы лидер и инициатор. Влияние на окружающих выражается в ведении за собой, однако ваша прямолинейность требует самоконтроля, чтобы не перерасти в конфликтность."
    },
    phlegmatic: {
        title: "Стабильный Флегматик",
        desc: "<b>Психологический портрет:</b> Вы — оплот спокойствия и надежности. Ваша нервная система инертна, но крайне сильна. Как личность, вы демонстрируете высокую устойчивость к внешним раздражителям.<br><br><b>В общении:</b> На вас всегда можно положиться. Вы вносите в коллектив баланс и рассудительность. Ваше влияние проявляется в стабилизации напряженных ситуаций."
    },
    melancholic: {
        title: "Глубокий Меланхолик",
        desc: "<b>Психологический портрет:</b> Вы обладаете тонкой душевной организацией. Ваша чувствительность (индивид) позволяет вам видеть мир глубже других. Процесс формирования вашей личности идет через рефлексию.<br><br><b>В общении:</b> Вы — тактичный и преданный друг. Ваше влияние на людей мягкое и вдохновляющее. Вы чувствуете то, что другие упускают из виду."
    }
};
...
function handleAnswer(val) {
    ...
    // Эффект плавного затухания при смене вопроса
    const card = document.querySelector('.content-wrapper');
