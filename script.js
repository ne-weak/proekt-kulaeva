...
const results = {
    sanguine: { 
        ...
        fact: "Интересный факт: Сангвиники быстрее других типов адаптируются к новой среде и смене часовых поясов."
    },
    choleric: { 
        title: "Холерик", 
        ...
        fact: "Интересный факт: Холерики обладают самой быстрой реакцией среди всех типов, что делает их отличными спринтерами."
    },
    phlegmatic: { 
        title: "Флегматик", 
        desc: "<b>Психологический портрет:</b> Невозмутимый человек со спокойными стремлениями и ровным настроением. <br><br><b>В обществе:</b> Вы — «островок стабильности». В коллективе вас ценят за отсутствие интриг и умение объективно оценивать ситуацию без лишних эмоций. Вы лучший слушатель, к которому приходят за дельным советом.",
        fact: "Интересный факт: Флегматики способны дольше всех сохранять высокую концентрацию при монотонной работе."
    },
    melancholic: { 
        title: "Меланхолик", 
        desc: "<b>Психологический портрет:</b> Впечатлительный человек, склонный к глубоким переживаниям даже незначительных событий. <br><br><b>В обществе:</b> Вы — эмпат и глубокий аналитик. В отношениях вы самый преданный друг, который чувствует состояние другого человека без слов. Вы замечаете риски и детали, которые упускают остальные.",
        fact: "Интересный факт: Большинство выдающихся творцов и философов были меланхоликами из-за их способности к рефлексии."
    }
};
